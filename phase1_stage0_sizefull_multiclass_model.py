...
all_info = pd.read_csv("./img/size_full/all_info_"+date+".csv")
all_info.download_path = all_info.download_path.str.replace("./size_full", "./img/size_full")
# IMG_SIZE = (None, None)
...
all_info.to_csv(path_or_buf="./output/all_info_sizefull_stage0filtered_" + date +".csv")