...
all_info = pd.read_csv("./output/all_info_filtered_for_planes_03May2022.csv")
all_info = all_info.loc[all_info.qc_class.isin(["airliner", "warplane"]), ].reset_index()
all_info.sample(10)
...
model.save('./model/all9variants_dataframemodel_03May2022')
...
model = keras.models.load_model("./model/all9variants_dataframemodel_03May2022")
...
all_info_output.to_csv(path_or_buf="./output/all9classes_predictions_03May2022.csv")