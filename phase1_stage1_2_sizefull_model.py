...
all_info = pd.read_csv("./output/all_info_sizefull_stage0filtered_" + date + ".csv")
...
base_model = keras.models.load_model('/Users/kevinwang/GitHub/plane_variants/model/all9variants_dataframemodel_03May2022')
...
model.save('./model/all9variants_dataframemodel_' + date)
...
model = keras.models.load_model("./model/all9variants_dataframemodel_" + date)
...
all_info_output.to_csv(path_or_buf="./output/all9classes_predictions_" + date + ".csv")

import json
with open("./output/all9class_index.json", "w") as outfile:
